...
import {CAIEnemyMeleeSlowLargeWaypoint} from "../../../CComponent/AI/Waypoint/CAIEnemyMeleeSlowLargeWaypoint";
import {EnemyWaypoint} from "../../../CComponent/AI/Waypoint/EnemyWaypoint";

export class CUnitTypeEnemyMeleeMyrmidionWaypoint extends CUnit {
    public poise = 2;
    ...
    public constructor(owner: player, position: Vector2, guardPos: EnemyWaypoint[]) {
        ...
        this.addComponent(new CAIEnemyMeleeSlowLargeWaypoint(this, guardPos));
