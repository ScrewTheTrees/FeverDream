...
export function buildEntireMap() {
    ...
    try {
        ...
        if (config.minifyLua) {
            ...
            destroy.keyPhrasePostfix = "SSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMM";
            destroy.keyPhrasePrefix = "SSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMMSSSSPPPPAAAAMMMM";
